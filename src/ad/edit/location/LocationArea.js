...
import {
    FETCH_LOCATION_AREA_BEGIN,
    SET_LOCATION_AREA_TYPEAHEAD
} from './locationAreaReducer';
import { ADD_LOCATION_AREA, REMOVE_COUNTRY, REMOVE_COUNTY, REMOVE_MUNICIPAL } from '../../adDataReducer';
...
class LocationArea extends React.Component {
    ...
    render() {
        const { municipalsCounties, countries, typeaheadValue, validation, locationList } = this.props;
...
LocationArea.propTypes = {
    ...
    municipalsCounties: PropTypes.arrayOf(PropTypes.shape({
